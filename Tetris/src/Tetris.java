...
public class Tetris extends Window implements ActionListener{
    ...
    public static final int H = 20, W = 10, C = 25; // C is the cell width, W and H are width and height of the well.
    public static final int xM = 50, yM = 50;
    public static final int iBkCol = 7; // index of the black color
    ...
    public static void zagWell() {
        for (int y = 0; y < H; y++) {zagRow(y);}
    }

    public static void zagRow(int y) {
        for(int x = 0; x < W; x++) {
            if(well[x][y] == iBkCol) {
                return;
            }
    ...
    public static class Shape {
        ...
        public void drop() {
            ...
            if(collisionDetected()) {
                ...
                zagWell(); 
                dropNewShape();
            } // copy the four cells into the well. set the shape back to 0.
            loc.add(G.DOWN); 
        }
